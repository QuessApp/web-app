...
export const FeedError = () => {
  return (
    <div className="flex h-[300px] w-full max-w-[650px] shrink-0 items-center justify-center rounded-md border border-dashed border-slate-200 bg-white dark:border-slate-700 lg:h-[350px]">
